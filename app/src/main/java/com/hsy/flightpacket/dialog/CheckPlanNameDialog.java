...
public class CheckPlanNameDialog extends BaseDialogManager {
    ...
    public CheckPlanNameDialog(Context context, PlanNameListener nameListener) {
        super(context);
    ...
    public CheckPlanNameDialog(Context context) {
        super(context);
